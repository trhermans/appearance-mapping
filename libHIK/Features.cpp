...
SURFFeature::SURFFeature(const bool _useSobel,const int _L1_norm)
...
void SURFFeature::setNextSURFFeature()
{
}
int* SURFFeature::I_feature(const int x1,const int x2,const int y1,const int y2)
{
  return i_feature.buf;
}

const IntImage<double>& SURFFeature::AssignFile(const char* filename,
...
const IntImage<double>& SURFFeature::AssignImage(IntImage<double>& image,
                                                 const int resizeWidth)
{
...
const IntImage<double>& SURFFeature::ResizeImage(const double ratio)
{
