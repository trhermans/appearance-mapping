...
public:
	...
	double getNormalizationTerm(std::vector<double> p_Zk_Li, InterfaceObservationLikelihood* observationLikelihood, InterfaceDetectorModel* detectorModel, InterfacePlaceModel* placeModel, InterfaceLocationPrior* locationPrior);
